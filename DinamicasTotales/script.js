...
for (i = 0; i < n; i++) {  //a cada espacio de la matriz segun n se le inserta un vector de 2 posiciones
...
function imprimirMatrizEnPanel(matriz, panel) {
    ...
    for (let i = 0; i < matriz.length; i++) {
      ...
      for (let j = 0; j < matriz[i].length; j++) {
        ...
        cell.style.border = "1px solid black"; // Estilo de borde para cada celda
